...
/**
 * Code available here: https://gist.github.com/janih/4536956
 * It has public Domain
 * <p>
...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	 ...
	 * @see #getNumberOfComments #getNumberOfComments#getNumberOfComments
	 */
	 ...
	 * @see #getPhysicalWidthDpi() #getPhysicalWidthDpi()#getPhysicalWidthDpi()
	 * @see #getPhysicalHeightInch() #getPhysicalHeightInch()#getPhysicalHeightInch()
	 */
	 ...
	 *
	 * @return physical height (in dpi)
	 * @see #getPhysicalHeightDpi() #getPhysicalHeightDpi()#getPhysicalHeightDpi()
	 * @see #getPhysicalWidthDpi() #getPhysicalWidthDpi()#getPhysicalWidthDpi()
	 * @see #getPhysicalWidthInch() #getPhysicalWidthInch()#getPhysicalWidthInch()
	 */
	...
	public static void main(String[] args) {
		ImageInfoUtils imageInfo = new ImageInfoUtils();
		imageInfo.setDetermineImageNumber(true);
		boolean verbose = determineVerbosity(args);
		File image = new File ("C:/Users/ccabral/AppData/Local/Temp/OX/allette.app.tmp/OBJECTIVE-81B010-B2E/packer/images/43_02s08_knox-6-1.jpeg");
    try {
      InputStream in = new FileInputStream(image);
      run(image.getName(), in, imageInfo, verbose);
	...
	private static void printCompact(String sourceName, ImageInfoUtils imageInfo) {
		final String SEP = "\t";
		System.out.println(
			sourceName + SEP +
	...
	private static void printVerbose(String sourceName, ImageInfoUtils ii) {
	 ...
	 */
	public static void run(String sourceName, InputStream in, ImageInfoUtils imageInfo, boolean verbose) {
	 ...
	 * @see #getNumberOfComments #getNumberOfComments#getNumberOfComments
	 * @see #getComment #getComment#getComment
	 */
	 ...
	 * @see #getNumberOfImages #getNumberOfImages#getNumberOfImages
	 */
